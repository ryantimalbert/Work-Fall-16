...
Information_file=open("Information File_syringae.fna","w")
...
id_file1=open("Missing_Genes_syringae.id.fna","w")
for sequence in id_missing:
    id_file1.write(sequence+'\n')
SeqIO.write(fasta_missing, "Missing_Genes_syringae.cds.fna", "fasta")
id_file2=open("Found_Genes_syringae.id.fna","w")
for sequence in id_found:
    id_file2.write(sequence+'\n')
SeqIO.write(fasta_found, "Found_Genes_syringae.cds.fna", "fasta")
