...
score = cross_validation.cross_val_score(clf, features, target, cv = 50)
print(score.mean())
print(score.std())

clf = RandomForestClassifier(n_estimators = 100, min_samples_split = 1)
score = cross_validation.cross_val_score(clf, features2, target2, cv = 50)
print(score.mean())
print(score.std())
...
clf = RandomForestClassifier(n_estimators = 100, min_samples_split = 1)
score = cross_validation.cross_val_score(clf, new_features2, target2, cv = 50)
print(score.mean())
print(score.std())
...
clf = RandomForestClassifier(n_estimators = 100, min_samples_split = 1)
score = cross_validation.cross_val_score(clf, combined, target2, cv = 50)
print(score.mean())
print(score.std())
